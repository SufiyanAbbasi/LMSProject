...
namespace LMSAPI.Migrations
{
    ...
    [Migration("20240605121952_adddata")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LMSAPI.Entities.Book", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMSAPI.Entities.BookCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMSAPI.Entities.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMSAPI.Entities.User", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LMSAPI.Entities.Book", b =>
                {
                    b.HasOne("LMSAPI.Entities.BookCategory", "BookCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("LMSAPI.Entities.Order", b =>
                {
                    b.HasOne("LMSAPI.Entities.Book", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LMSAPI.Entities.User", "User")
                        .WithMany()
